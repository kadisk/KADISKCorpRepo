	...
	return <>
		<div className="row g-0 flex-fill">
							...
							<div className="input-group input-group-flat">
								...
								<span className="input-group-text">
									<a href="#" className="link-secondary" data-bs-toggle="tooltip" aria-label="Show password" data-bs-original-title="Show password">
										<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="icon icon-1"><path d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0 -4 0"></path><path d="M21 12c-2.4 4 -5.4 6 -9 6c-3.6 0 -6.6 -2 -9 -6c2.4 -4 5.4 -6 9 -6c3.6 0 6.6 2 9 6"></path></svg>
									</a>
								</span>
							</div>
						</div>
			...
			<div className="col-12 col-lg-6 col-xl-8 d-none d-lg-block">
				...
				<div className="bg-cover h-100 min-vh-100" style={{ backgroundImage: `url(${coverPicture})` }}></div>
			</div>
		</div>
	</>
}
